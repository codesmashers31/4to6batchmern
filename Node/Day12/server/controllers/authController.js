import authModle from "../modles/authModle.js"
...
export const insertData = async (req,res)=>{
  ...
  try {
    ...
    const emailCheck = await authModle.findOne({email})
    ...
    const insertAuth = await authModle.create({username,email,password:hashing})
